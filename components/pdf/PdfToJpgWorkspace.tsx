      ...
      <div className="space-y-6">
        ...
        <div
          ...
          className={`
            ...
            transition-all touch-manipulation select-none py-12 sm:py-16 px-4
            ${
              isDraggingOver
            ...
            <div>
              <p className="text-base font-bold text-slate-800 dark:text-slate-100">
                {status === 'loading_doc' ? (
                  ...
                  <>
                    Drop your PDF file here or <span className="text-indigo-600 dark:text-indigo-400 underline">browse</span>
                  </>
                )}
              </p>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                Fast, secure client-side extraction · Up to 50 MB
              </p>
            </div>
          </div>
        </div>
